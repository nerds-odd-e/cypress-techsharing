...
<div class="flex flex-col items-center p-3">
	...
	<form class="w-full sm:w-1/2" on:submit|preventDefault={handleSubmit(group)}>
		<div class="border-teal p-8 border-t-12 bg-white mb-6 rounded-lg shadow-lg">
			...
			<div class="mb-4">
				<label for="stateOrProvince" class="block font-semibold text-gray-800 mb-2 text-left"
			...
			<div class="mb-4">
				<label for="postalCode" class="block font-semibold text-gray-800 mb-2 text-left"
					>Postal Code</label
				>
				<input
					id="postalCode"
			...
			<div class="flex pt-4 gap-2">
				<button
					type="submit"
					class="flex-1 bg-gray-500 border border-gray-600 text-white py-3 rounded w-full text-center shadow hover:font-medium hover:bg-gray-600 border-b-4 border-gray-700"
					>Submit</button
				>
			</div>
		</div>
